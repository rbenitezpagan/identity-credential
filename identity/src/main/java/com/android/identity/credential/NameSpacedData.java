 ...
 *
 * <p>This class implements the MDOC data model which consists of a series of name spaces
 ...
 *
 * <p>While specific to the MDOC credential shape, this construct is flexible enough to
 * be used to store credential data for any shape of credential.
 *
